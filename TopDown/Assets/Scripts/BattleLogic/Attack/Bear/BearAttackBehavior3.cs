...
public class BearAttackBehavior3 : AttackBehavior
{
    ...
    public override void ExecuteAttack(GameObject target = null, Transform startPoint = null)
    {
        if (target != null)
        {
            ...
            int calcDamage = (int)(1.8f * attackStat.GetModifiedValue(Define.UnitAttribute.Attack) - targetStat.GetModifiedValue(Define.UnitAttribute.Defence));
    ...
    {
        AnimationIndex = (int)Define.MonsterAttackPattern.Attack3;
        Priority = (int)Define.AttackPrioty.Third;
        Value = 10;
        Range = 2f;
        coolTime = 3f;
        calcCoolTime = 0f;
