...
public class PlayerMoveState : State<PlayerController>
{
    ...
    public override void Enter()
    {
        ...
        _animator.SetFloat(hashMoveSpeed, context.speed);
    }

    public override void Update(float deltaTime)
    {
        _animator.SetFloat(hashMoveSpeed, context.speed * 10);
        ...
        if (_navAgent.remainingDistance > _navAgent.stoppingDistance)
        {
            ...
            _characterController.Move(_navAgent.desiredVelocity * context.speed * deltaTime);
